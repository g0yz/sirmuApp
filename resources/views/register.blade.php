...
<div class="registration-container">
  <div class="registration-form">
    <h2 class="text-center mb-4">Ingresar Datos
    </h2> <!-- Título agregado -->
    <form>
      <input type="text" class="form-control mb-2" placeholder="Nombre de usuario" required>
      ...
      <input type="email" class="form-control mb-2" placeholder="Correo electrónico" required>
