...
<div class="registration-container">
  <div class="registration-form p-4 bg-white rounded shadow-sm">
    ...
    {{-- Si no hay encargados disponibles --}}
    @if($encargados->isEmpty())
      <div class="alert alert-warning my-3">
        No hay <strong>encargados</strong> disponibles para asignar.  
        Cree un usuario con rol <em>encargado</em> o libere uno antes de dar de alta una sede.
      </div>
      <a href="{{ route('admin.usuarios.create') }}" class="btn btn-primary">Crear encargado</a>
    @else
      {{-- Formulario normal --}}
      <form method="POST" action="{{route('admin.sedes.store')}}" enctype="multipart/form-data">
        ...
        <select name="encargado_id" class="form-select mb-2" required>
